...
public class FileDescriptorLeakServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            //TODO: Replace baseDirectory with the relevant target directory path within the file system
            if (FileSecurityUtils.isFileOutsideDir(file.toString() + File.separator + true.toString(),
                    "baseDirectory")) {
